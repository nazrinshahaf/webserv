...
namespace webserv
{
	class	ServerNormalDirectiveConfig : public ServerBaseConfig
	{
		public:
			...
			//const pair<string, pair<string, string> >	&get_config(void) const;
			...
			//const pair<string, string>	&get_value_pair(void) const;

			//void set_config(const string &key,
		...
		private:
			//pair<string, pair<string, string> >	_config;
